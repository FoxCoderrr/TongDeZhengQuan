  ...
  <div class="wrap clearfix">
    <div class="form bs_form">
      ...
      <div class="clearfix">
        ...
        <div class="f_r">
          <el-input v-model.number="code" placeholder="股票代码" clearable readonly></el-input>
        </div>
      </div>
      <div class="clearfix">
        <span class="f_l">卖出价格：</span>
        <div class="f_r">
          <el-input @input="inputCoin" v-model.number="price" placeholder="委托价格" clearable readonly></el-input>
        </div>
      </div>
      <div class="clearfix">
        <span class="f_l">卖出手数：</span>
        <div class="f_r">
          <el-input @input="inputCoin1" v-model.number="num" placeholder="卖出手数" clearable></el-input>
        </div>
      </div>
      <div class="clearfix bs_btn s_btn">
        <el-button @click="sell" type="primary" :loading="bool1">市价平仓</el-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    select(row, e, col) {
      ...
      this.formInfo(row.short,row.num);
            ...
            .then(function(res) {
              if (res.data.code == 1) {
                if (res.data.data.code == 1) {
                  ...
                  let short =
                    that.code.slice(0, 1) == 6 ? "sh" : "sz" + that.code;
                  that.formInfo(short);
